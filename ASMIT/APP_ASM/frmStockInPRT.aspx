<%@ Page Title="" Language="C#" MasterPageFile="~/APP_ASM/MainASM.Master" AutoEventWireup="true" CodeBehind="frmStockInPRT.aspx.cs" Inherits="HDPortal.APP_ASM.frmStockInPRT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadCustomHolder" runat="server">
    <!--Custom CSS -->
    <!--Custom JS -->
    <script src="frmStockInPRT.js" type="text/javascript"></script>
</asp:Content>
