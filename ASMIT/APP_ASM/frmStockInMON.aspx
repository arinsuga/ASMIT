<%@ Page Title="" Language="C#" MasterPageFile="~/APP_ASM/MainASM.Master" AutoEventWireup="true" CodeBehind="frmStockInMON.aspx.cs" Inherits="HDPortal.APP_ASM.frmStockInMON" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadCustomHolder" runat="server">
    <!--Custom CSS -->
    <!--Custom JS -->
    <script src="frmStockInMON.js" type="text/javascript"></script>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageContentHolder" runat="server">
    <div style="width:700px;height:400px;">
        <img style="width:700px;height:400px;" src="../Contents/UnderDevelopment.gif" />
    </div>
</asp:Content>
